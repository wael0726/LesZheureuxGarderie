               ...
               <div class="row">
                  ...
                  <div class="col-lg-9 page-with-sidebar-left order-lg-2">
                     ...
                     <div class="card blog-card ">
                        ...
                        <div class="card-body">
                           <a href="blog-single.html">
                              <h3 class="card-title">Day Care 101: How to Choose the best Facilities</h3>
                           </a>
                           <div class="post-info text-muted">
                              <i class="fas fa-calendar margin-icon"></i>January 2, 2018 by
                              <a href="#">Lila Smith</a> /  <i class="fas fa-comment margin-icon"></i><a href="#">23 comments</a>
                           </div>
                           <!-- excerpt -->
                           ...
                           <a href="blog-single.html" class="btn btn-secondary">Read More &rarr;</a>
                        </div>
                        <!--card-footer -->
                     </div>
                     <!-- /card blog-card -->
                     ...
                     <div class="card blog-card ">
                        ...
                        <div class="card-body">
                           <a href="blog-single.html">
                              <h3 class="card-title">Helping Your Child with Socialization</h3>
                           </a>
                           <div class="post-info text-muted">
                              <i class="fas fa-calendar margin-icon"></i>January 21, 2018 by
                              <a href="#">Lila Smith</a> /  <i class="fas fa-comment margin-icon"></i><a href="#">10 comments</a>
                           </div>
                           <!-- excerpt -->
                           <p class="card-text mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
                           <a href="blog-single.html" class="btn btn-secondary">Read More &rarr;</a>
                     ...
                     <div class="card blog-card ">
                        ...
                        <div class="card-body">
                           <a href="blog-single.html">
                              <h3 class="card-title">Our Healthy meals that toddlers love</h3>
                           </a>
                           <div class="post-info text-muted">
                              <i class="fas fa-calendar margin-icon"></i>January 1, 2018 by
                              <a href="#">Lila Smith</a> /  <i class="fas fa-comment margin-icon"></i><a href="#">10 comments</a>
                           </div>
                           <!-- excerpt -->
                           <p class="card-text mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis aliquid atque, nulla? Quos cum ex quis soluta, a laboriosam. Dicta expedita corporis animi vero voluptate voluptatibus possimus, veniam magni quis!</p>
